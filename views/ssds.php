                            ...
                            if(Application::$app->session->get('user')){
                                if($_SESSION['user'][0]['role'] == 'Admin'){
                                    echo "<div class='col-12 col-md-6 col-lg-4'>
                                            ...
                                            <div class='image'><a href='/addSSD'><img class='img-fluid d-block mx-auto' src='assets/img/gpu_default.jpg' style='width: 230px;margin: 0px;margin-top: 24px;height: 120px;margin-bottom: 24px;'></a></div>
